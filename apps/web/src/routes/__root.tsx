...
import { MacOSNotificationCoordinator } from "../components/desktop/MacOSNotificationCoordinator";
  ...
  return (
    <ToastProvider>
      <AnchoredToastProvider>
        ...
        {primaryEnvironmentAuthenticated ? <MacOSNotificationCoordinator /> : null}
