...
class DesktopExistingLocalBackendUnavailableError extends Schema.TaggedError<DesktopExistingLocalBackendUnavailableError>()(
...
class DesktopExistingLocalBackendLoadError extends Schema.TaggedError<DesktopExistingLocalBackendLoadError>()(
